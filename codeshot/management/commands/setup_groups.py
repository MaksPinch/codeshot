# Ваше_приложение/management/commands/setup_groups.py
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        group_export_users, created_export_users = Group.objects.get_or_create(
            name="Export users"
        )
        group_analysts_users, created_analysts_users = Group.objects.get_or_create(
            name="Analysts"
        )
